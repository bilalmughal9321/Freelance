...
class MapVC: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        addMarkerAtSpecificLocation(latitude: 25.1966, longitude: 55.2811)
    }
    ...
    private func addMarkerAtSpecificLocation(latitude: CLLocationDegrees, longitude: CLLocationDegrees) {
        ...
        annotation.title = "Duabi Mall" // Marker title
        annotation.subtitle = "Reel Cinemas" // Optional subtitle
