...
struct MediaCarousel: View {
    ...
    private let medias: [MediasModel]
    private let placement: Placement
    private let additionHandler: (Data) -> Void
    private let deletionHandler: (MediasModel.ID) -> Void

    @State private var selected: MediasModel?
    ...
    private func cell(for media: MediasModel) -> some View {
        AsyncImage(
