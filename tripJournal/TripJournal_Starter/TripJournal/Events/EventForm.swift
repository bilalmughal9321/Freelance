...
struct EventForm: View {
    ...
    private func addEvent() async {
        ...
        do {
            ...
            if let value = transitionFromPrevious {
                params["transition_from_previous"] = value
            }
                        
            try await vm.createEvents(param: params)
    ...
    private func editEvent(withId id: Event.ID) async {
        ...
        do {
            ...
            try await vm.configureEvent(id: id, param: params, method: .PUT)
    ...
    private func deleteEvent(withId id: Event.ID) async {
        isLoading = true
        do {
            try await vm.configureEvent(id: id, method: .DELETE)
